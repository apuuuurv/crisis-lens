...
class Incident(Base):
    ...
    # NEW COLUMNS FOR VERIFICATION & PERSISTENCE
    image_url = Column(String, nullable=True) # Point to /uploads/filename
    upvotes = Column(Integer, default=0)
    is_verified = Column(Boolean, default=False)
    trust_score = Column(Float, default=0.0) # 0.0 to 1.0 based on AI/Metadata check
    verification_notes = Column(String, nullable=True) # AI-reasoning summary
