...
if allowed_origins_env:
    # Append comma-separated origins from environment, ensuring no trailing slashes
    allowed_origins.extend([origin.strip().rstrip("/") for origin in allowed_origins_env.split(",")])
